...
export type ReassignIterationInput = {
...
export type Mutation_Root = {
  ...
  reassign_iteration: Scalars['Boolean']['output'];
...
/** mutation root */
export type Mutation_RootReassign_IterationArgs = {
  input: ReassignIterationInput;
};
...
export type ReassignIterationMutationVariables = Exact<{
  input: ReassignIterationInput;
}>;


export type ReassignIterationMutation = { __typename?: 'mutation_root', reassign_iteration: boolean };
...
export const ReassignIterationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReassignIteration"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ReassignIterationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reassign_iteration"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<ReassignIterationMutation, ReassignIterationMutationVariables>;
