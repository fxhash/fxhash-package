export const alphabet = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ";
...
export function createFxRandom(fxhash:string, start: number): ResettableRandFunction {
