...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-0.5 border-b border-b-border bg-grey-900 p-4 group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:gap-1.5 md:text-left",
        className
      )}
      {...props}
    />
...
const DrawerFooter = ({
  ...
  <div
    className={cn(
      "mt-auto flex flex-col gap-2 bg-grey-900 p-4 pb-24",
      className
    )}
    {...props}
  />
