...
// class Error1 extends RichError {
//   name = "Error1" as const
// }
// class Error2 extends RichError {
//   name = "Error2" as const
// }
// class Error3 extends RichError {
//   name = "Error3" as const
// }
// class Error4 extends RichError {
//   name = "Error4" as const
// }
// class Error5 extends RichError {
//   name = "Error5" as const
// }
...
// type Q = Extract<
//   TMessages1["frame->host"][keyof TMessages1["frame->host"]],
//   { errors: RichError }
// >["errors"]

// class TestHost extends IframeBDCommHost<TMessages1, never> {}
// class TestFrame extends IframeBDCommFrame<TMessages1> {
//   constructor() {
//     super()
//   }
// }
