...
export const FxhashContracts = {
  ...
  ETH_PROJECT_FACTORY: config.ETH_PROJECT_FACTORY_V1,
  ...
  ETH_DUTCH_AUCTION_V1: config.ETH_DUTCH_AUCTION_V1,
  ETH_MINT_TICKETS_FACTORY_V1: config.ETH_MINT_TICKETS_FACTORY_V1,
}
