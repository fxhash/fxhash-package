...
import type { ISplitsMain, ISplitsMainInterface } from "../ISplitsMain";
...
export class ISplitsMain__factory {
  static readonly abi = _abi;
  static createInterface(): ISplitsMainInterface {
    return new utils.Interface(_abi) as ISplitsMainInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISplitsMain {
    return new Contract(address, _abi, signerOrProvider) as ISplitsMain;
  }
}
