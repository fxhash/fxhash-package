...
import { NFTArticle, User } from "@fxhash/shared"
...
export class ListingV3Operation extends TezosContractOperation<TListingV3OperationParams> {
    ...
    return this.manager.tezosToolkit.wallet
      ...
      .with([
        ...
        },
        {
          ...
          parameter: {
            entrypoint: "listing",
            value: buildParameters(listingParams, EBuildableParams.LISTING_V3),
          },
          storageLimit: 450,
        },
      ])
  ...
  success(): string {
    return `You have listed ${this.params.amount} of ${
      this.params.article.title
    }for ${displayMutez(parseInt(this.params.price))} tez each`
  }
}
