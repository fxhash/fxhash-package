...
import { GenerativeTokenMetadata, MintGenerativeData } from "@fxhash/shared"
 ...
 */
export class TezosMintIssuerOperation extends TezosContractOperation<TMintIssuerOperationParams> {
